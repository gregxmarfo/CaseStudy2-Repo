...
GdpPlot <- ggplot(data=ProcrastinationHdiData_18_or_older, aes(x=reorder(Country,Country,length)))
GdpPlot <- GdpPlot + geom_bar(aes(y = (..count..))) + scale_y_continuous() + theme(axis.text.x = element_text(angle = 90, hjust = 1)) 
GdpPlot <- GdpPlot + xlab("Country") + ylab("Count of participants") + ggtitle("Count of participants by Country")
print(GdpPlot)
